 ...
 *
 * <p>커넥션 풀 고갈 위험도 없다 — BAT-SCH-01(BatchExecutionOrchestrator)이 조합을 항상 단일 스레드로
 * 순회해(CLAUDE.md "REQUIRES_NEW 격리 INSERT 게이트웨이 패턴" 절 참고) 동시에 열리는 커넥션이
 * "청크 트랜잭션 1개 + 이 REQUIRES_NEW 1개" = 최대 2개뿐이다.
 */
@Component
