...
export function AlertCircleIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      />
      <path d="M7 4.66667V7" stroke="currentColor" strokeWidth="1.16667" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M7 9.33333H7.00583" stroke="currentColor" strokeWidth="1.16667" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
